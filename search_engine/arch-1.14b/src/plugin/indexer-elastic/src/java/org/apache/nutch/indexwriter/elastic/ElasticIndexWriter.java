...
// import org.elasticsearch.transport.client.*; NOT RESOLVED BECAUSE INDEXING TO ELASTIC SEARCH IS NOT SUPPORTED
...
public class ElasticIndexWriter implements IndexWriter {
  ...
  protected Client makeClient(Configuration conf) throws IOException {
    ...
    if (hosts != null && port > 1) {
      throw new RuntimeException( "Indexing to Elasticsearch is not supported" ) ; 
