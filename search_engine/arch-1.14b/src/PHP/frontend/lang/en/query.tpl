...
{literal}
  ...
  var phrase_search = "To find phrase in a particular field, please use the precision search form." ;
...
<fieldset>
  ...
  <div id="standardPanel"> 
   <form name="search1" id="search1" action="arch.php" method="get">
    <table width="100%">
     <tr>
     ...
     <tr>
       <td colspan=2 align="center" class="q" style="padding-left:0.5cm">
        This engine supports <a href="http://lucene.apache.org/core/old_versioned_docs/versions/2_9_1/queryparsersyntax.html">Lucene query syntax.</a>
       </td>
     </tr>
    </table>
...
<fieldset>
  ...
  <div id="advancedPanel"> 
   ...
   <form name="search2" id="search2" action="arch.php" method="get">
    <table width="100%">
     <tr>
