...
public final class ParserFactory {
  ...
  public Parser getParserById(String id) throws ParserNotFound {
    ...
    if (objectCache.getObject(parserExt.getId()) != null) {
      ...
      try {
        ...
        if (LOG.isWarnEnabled()) {
          LOG.warn("Cannot initialize parser "
  ...
  private List<Extension> findExtensions(String contentType) {
    ...
    List<Extension> extensionList = parsePluginList == null ? null :
    ...
    if (plugins != null) {
        ...
        if (ext == null) {
          ...
          if (LOG.isWarnEnabled()) {
            if (ext != null) {
              ...
              // particular mimeType
              LOG.debug("ParserFactory:Plugin: " + parsePluginId
      ...
      if (extList.size() > 0) {
        if (LOG.isInfoEnabled()) {
          ...
          extensionsIDs.append("]");
          LOG.debug("The parsing plugins: " + extensionsIDs.toString()
